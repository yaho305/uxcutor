		...
		<div class="left-corner">
			...
			<form name="scForm" id="scForm">
				...
				<input type="hidden" name="curPage" id="curPage" value="${curPage}" />
					<fieldset>
						<div class="form_table">
							<table border="1" cellspacing="0" summary="사용자 정보">
								...
								<td>
									<div class="item">
										<input type="text" id="id" name="id" class="i_text" style="ime-mode: disabled;" onKeyDown="onNotText(this);" readonly value="${user.id}">
								...
								<td>
									<div class="item">
										<input type="text" id="name" name="name" title="이름" class="i_text" maxlength="16" value="${user.name}">
									</div>
								</td>
								</tr>
								</tbody>
				...
				<div class="btn_center">
					<span class="btn_pack medium"><span class="edit"></span><a href="#" id="insert">등록</a></span>
					<span class="btn_pack medium"><span class="list"></span><a href="#" onClick="goList();">목록</a></span>
				</div>
				<!-- //버튼 -->
		</div>
	</div>
